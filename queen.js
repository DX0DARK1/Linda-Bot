...
console.log("ANAS EN NAJJARI Session downloaded ✅")
})})}
...
console.log("Connecting ANAS EN NAJJARI 🔻...");
...
console.log('Anas En Najjari Is Installing... ')
...
console.log('ANAS EN NAJAJRI connected to whatsapp ✅')

let up = `
 **LINDA Queen Connected Successfully!** ✅ 
...
app.get("/", (req, res) => {
res.send("hey I am alive, ANAS EN NAJJARI Is started✅");
});
